...
│
├── data/
│   └── Crop_Prediction_dataset.csv       ← Put your dataset here
│
├── notebooks/
│   └── Crop_ML_Project.ipynb             ← Main ML notebook (85%+ accuracy)
│
├── models/                               ← Auto-created when notebook runs
│   ├── crop_classifier.pkl               ← Random Forest Classifier (PRIMARY)
...
│   ├── agg_features.json                 ← Group aggregates for prediction
│   ├── state_district_map.json           ← State → Districts mapping
│   ├── meta.json                         ← States, seasons, feature list
│   ├── crop_distribution.png
│   ├── season_distribution.png
│   ├── feature_distributions.png
│   ├── correlation_heatmap.png
│   ├── feature_vs_production.png
│   ├── crops_per_state.png
...
│
├── app.py                                ← Flask backend (connects frontend to model)
├── requirements.txt
└── README.md
```
